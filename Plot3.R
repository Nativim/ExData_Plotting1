...
plot(graph_data$Time, as.numeric(graph_data$Sub_metering_1), type = "l", xlab = "", ylab = "Energy sub metering")
lines(graph_data$Time, as.numeric(graph_data$Sub_metering_2), col="red")
